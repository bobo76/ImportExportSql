...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        {
            Assert.IsTrue(DataHelper.VerifyIfTableExist("EmailAddress", TestConnectrionString));
            Assert.IsFalse(DataHelper.VerifyIfTableExist("blablalba", TestConnectrionString));
        }
        ...
        public void TestTypeTable()
        {
            ...
            foreach (var curField in fieldList)
            {
                ...
                Assert.IsInstanceOfType(cur.Type, curField.Item3);
        ...
        public void TestImportExport()
        {
            ...
            var tableInfo = DataHelper.GetTableInfo("TestTypes", TestConnectrionString);
            Assert.IsNotNull(tableInfo);
            var sourceFilePath = @"..\..\Data\TestTypes_2018-05-06.txt";
            ...
            var fileName = @"..\..\Data\" + tableInfo.TableName + DateTime.Now.ToString("_yyyy-MM-dd_hh-mm") + ".txt";
        ...
        //public void TestTmp()
        //{
        //    Assert.IsTrue(DataTypeFactory.GetCount() == 17);
        //}
